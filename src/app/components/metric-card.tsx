...
export default function MetricCard({
  ...
  return (
    <motion.div
      className={`p-6 rounded-xl backdrop-blur-lg border cursor-pointer transition-all ${
        isSelected ? "bg-white/20 border-white/40" : "bg-white/10 border-white/20 hover:bg-white/15"
      }`}
      onClick={onClick}
